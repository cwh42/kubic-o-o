...
In [Kubic](https://kubic.opensuse.org), we leverage all of this to build an excellent container operating system, providing users with the latest versions of exciting new tools like [Podman]({% post_url blog/2018-03-25-podman %}), [CRI-O]({% post_url blog/2018-09-17-crio-default %}), Buildah, and (of course) Kubernetes.
